...
__all__ = [
    'DISPID_SOTsItem', 'eLEXTYPE_PRIVATE11',
    'DISPID_SVSLastBookmarkId', 'ISpXMLRecoResult',
    'DISPID_SPARecoResult', 'DISPID_SRRTStreamTime',
    'DISPID_SPRulesCount', 'DISPID_SpeechAudioStatus',
    'DISPID_SRRecognizer', '_SPAUDIOSTATE', 'DISPID_SASNonBlockingIO',
    'DISPID_SVEventInterests', 'DISPID_SPRuleParent',
    'eLEXTYPE_PRIVATE19', 'SPEI_RESERVED3', 'SVP_16',
    'SVEEndInputStream', 'DISPID_SPEsCount',
    'DISPID_SLRemovePronunciation', 'ISpeechGrammarRuleState',
    'ISpeechVoiceStatus', 'DISPID_SpeechMemoryStream',
    'SAFT44kHz16BitMono', 'DISPID_SGRSTText', 'DISPID_SVSkip',
    'SDTDisplayText', 'DISPID_SRRAudio', 'ISpeechPhraseAlternates',
    'DISPID_SPEDisplayAttributes', 'UINT_PTR', 'DISPID_SRDisplayUI',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_APP', 'SECNormalConfidence',
    'SpCustomStream', 'DISPID_SDKGetStringValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechVoiceEvent', 'SPCT_SUB_COMMAND',
    'SAFT44kHz8BitStereo', 'SPEVENTENUM', 'DISPID_SpeechLexiconWords',
    'SRCS_Enabled', 'eLEXTYPE_PRIVATE5', 'SPFM_CREATE',
    'DISPID_SPILanguageId', 'ISpRecognizer3', 'SSTTTextBuffer',
    'DISPID_SOTCId', 'eLEXTYPE_PRIVATE13', 'SpeechWordPronounceable',
    'ISpeechPhraseRule', 'SVP_17', 'DISPID_SPIGetDisplayAttributes',
    'ISpRecoCategory', 'DISPID_SRRTLength', 'SPPS_RESERVED3',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechPhraseProperty',
    'eLEXTYPE_PRIVATE20', 'SPDKL_DefaultLocation',
    'DISPID_SVEEnginePrivate', 'SpeechLoadOption',
    'DISPID_SVSInputSentencePosition', 'ISpGrammarBuilder',
    'SWPKnownWordPronounceable', 'DISPID_SRCESoundStart',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVEAudioLevel', 'DISPID_SGRsItem',
    'SAFT16kHz8BitStereo', 'ISpeechLexiconPronunciations',
    'SPBOOKMARKOPTIONS', 'eLEXTYPE_PRIVATE14', 'SRTEmulated',
    'DISPID_SLGetGenerationChange', 'DISPID_SpeechRecoResultTimes',
    'SAFT8kHz16BitMono', 'SDTAlternates', 'SINoSignal', 'SPPHRASE',
    'SPAR_Low', 'DISPID_SPEAudioTimeOffset',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechTokenKeyFiles',
    'SpeechDisplayAttributes', 'ISpRecoContext', 'SPSERIALIZEDPHRASE',
    'DISPID_SLWType', 'ISpeechObjectTokens', 'SGRSTTWord',
    'SAFTExtendedAudioFormat', 'SECLowConfidence',
    'SAFTCCITT_uLaw_22kHzMono', 'SPAUDIOBUFFERINFO',
    'SAFT24kHz16BitMono', 'SLTApp', 'SPFM_NUM_MODES',
    'SDTLexicalForm', 'DISPID_SRIsUISupported',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_6',
    'SAFT48kHz8BitMono', 'SVP_5', 'SPEI_SENTENCE_BOUNDARY',
    'SPAO_RETAIN_AUDIO', 'SAFT12kHz16BitStereo', 'DISPID_SOTRemove',
    'SP_VISEME_4', 'ISpeechPhraseElement', 'SPSMF_SAPI_PROPERTIES',
    'tagSTATSTG', 'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_RESERVED1',
    'SPBINARYGRAMMAR', 'SPEI_WORD_BOUNDARY', 'DISPID_SRCEStartStream',
    'SP_VISEME_21', 'DISPID_SPEAudioSizeBytes', 'DISPID_SLWLangId',
    'ISpeechGrammarRules', 'SpeechTokenContext', 'DISPID_SpeechAudio',
    'SPAUDIOSTATUS', 'DISPID_SOTCategory', 'DISPID_SVRate',
    'SVEAllEvents', 'DISPID_SLPPhoneIds', 'ISpeechPhraseProperty',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRGSetTextSelection',
    'DISPID_SWFEExtraData', 'SGRSTTDictation',
    'DISPID_SpeechVoiceStatus', 'ISpeechRecoResultDispatch',
    'ISpPhoneticAlphabetSelection', 'SPEI_SR_PRIVATE', 'SRERequestUI',
    'DISPID_SCSBaseStream', 'SpeechTokenIdUserLexicon',
    'DISPID_SDKDeleteValue', 'SAFTCCITT_ALaw_8kHzMono',
    'STSF_FlagCreate', 'DISPID_SRStatus', 'SpPhraseInfoBuilder',
    'DISPID_SPCIdToPhone', 'SpeechVoiceCategoryTTSRate', 'SBOPause',
    'DISPID_SpeechXMLRecoResult', 'SWPUnknownWordUnpronounceable',
    'DISPID_SAVolume', 'ISpeechPhraseInfoBuilder', 'DISPID_SPPsItem',
    'SpeechEmulationCompareFlags', 'ISpeechLexiconPronunciation',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPPChildren',
    'DISPID_SRCBookmark', 'DISPID_SRGState', 'SPEI_HYPOTHESIS',
    'SVP_11', 'ISpMMSysAudio', 'SECHighConfidence', 'SPWORDLIST',
    'SpeechLexiconType', 'SPVPRI_ALERT', 'SAFT22kHz8BitMono',
    'DISPID_SRCERecognizerStateChange', 'ISpRecognizer',
    'SP_VISEME_15', 'SBONone', 'eLEXTYPE_MORPHOLOGY', 'SVSFParseSapi',
    'DISPID_SpeechPhraseInfo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SAFGetWaveFormatEx', 'SpeechSpecialTransitionType',
    'DISPID_SDKSetLongValue', 'SSFMOpenForRead', 'SVP_12',
    'DISPID_SpeechRecoResult2', 'SPPS_Function',
    'DISPID_SWFEChannels', 'eLEXTYPE_PRIVATE8', 'SPWORD',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPRNumberOfElements',
    'SpeechVoicePriority', 'SVP_4', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVSpeak', 'SVP_6', 'SpShortcut', 'DISPID_SBSSeek',
    'DISPID_SRSetPropertyString', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTCCITT_uLaw_11kHzMono', 'SVP_19',
    'SPFM_CREATE_ALWAYS', 'SPAS_PAUSE', 'SPAR_Medium',
    'SPFM_OPEN_READWRITE', 'SPBO_PAUSE', 'SPEI_REQUEST_UI',
    'DISPID_SPPId', 'DISPID_SpeechLexicon', 'SPBO_TIME_UNITS',
    'eLEXTYPE_PRIVATE7', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRSClsidEngine', 'ISpeechPhraseAlternate',
    'DISPIDSPTSI_ActiveLength', 'SpTextSelectionInformation',
    'Speech_StreamPos_Asap', 'SPEI_MIN_SR', 'DISPID_SRSAudioStatus',
    'SVF_Stressed', 'DISPID_SPACommit', 'DISPID_SLPs_NewEnum',
    'SPSHORTCUTTYPE', 'SAFTCCITT_uLaw_44kHzMono',
    'SpeechGrammarTagWildcard', 'SAFTADPCM_44kHzStereo',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SGRAttributes', 'STCAll',
    'DISPID_SVSPhonemeId', 'SPWF_SRENGINE', 'SPPS_Unknown',
    'SPEI_TTS_PRIVATE', 'SPAR_High', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechFileStream', 'SVEVoiceChange', 'SVSFNLPSpeakPunc',
    'DISPID_SPIStartTime', 'ISpShortcut', 'SREStreamStart',
    'SPWT_PRONUNCIATION', 'SGDSActiveUserDelimited',
    'DISPID_SPRuleChildren', 'ISpeechPhraseElements',
    'DISPID_SLWPronunciations', 'DISPID_SASCurrentSeekPosition',
    'SVSFPersistXML', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRGDictationUnload', 'SPAUDIOSTATE',
    'DISPID_SPIGrammarId', 'SP_VISEME_8', 'SpeechAudioVolume',
    'ISpeechLexiconWord', 'SpeechTokenValueCLSID', 'SPCT_SLEEP',
    'DISPID_SRGetRecognizers', 'DISPID_SASFreeBufferSpace',
    'DISPID_SLWs_NewEnum', 'SPPROPERTYINFO', 'eLEXTYPE_RESERVED9',
    'SVSFPurgeBeforeSpeak', 'ISpeechRecoContext', 'DISPID_SPRText',
    'eLEXTYPE_PRIVATE16', 'SVP_14', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPIProperties', 'SVP_9', 'DISPID_SPERetainedStreamOffset',
    'ISpPhoneticAlphabetConverter', 'SVSFParseMask',
    'SpeechInterference', 'SpCompressedLexicon',
    'DISPID_SVSInputWordPosition', 'DISPID_SVESentenceBoundary',
    'SPSInterjection', 'SAFTADPCM_11kHzStereo', 'SSSPTRelativeToEnd',
    'SpeechFormatType', 'DISPID_SABIEventBias',
    'DISPID_SRRSetTextFeedback', 'SpeechTokenKeyUI',
    'DISPID_SPRuleId', 'SINone', 'SAFT48kHz16BitMono',
    'eLEXTYPE_PRIVATE4', 'SDKLDefaultLocation',
    'DISPID_SGRSTPropertyId', 'DISPID_SRRAudioFormat', 'DISPID_SOTId',
    'DISPID_SPRuleFirstElement', 'SECFNoSpecialChars',
    'SpeechPropertyResponseSpeed', 'SpeechVisemeFeature',
    'DISPID_SMSADeviceId', 'SRADefaultToActive', 'SPRST_ACTIVE',
    'DISPID_SDKGetBinaryValue', 'SAFT32kHz16BitStereo',
    'SPRS_INACTIVE', 'DISPID_SRCVoice', 'SREStateChange',
    'SP_VISEME_20', 'DISPID_SREmulateRecognition',
    'SAFTGSM610_22kHzMono', 'SVSFUnusedFlags', 'SPSMF_UPS',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechRecoContext',
    'DISPID_SDKEnumValues', 'ISpeechRecoResult2', 'DISPIDSPTSI',
    'DISPID_SpeechPhraseProperties', 'ISpeechAudioStatus',
    'DISPID_SDKEnumKeys', 'SRAInterpreter', 'SP_VISEME_14',
    'ISpeechFileStream', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SITooLoud',
    'DISPID_SGRAddResource',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechBaseStream', 'DISPID_SGRSAddWordTransition',
    'SPEI_MAX_SR', 'SRATopLevel', 'SAFT24kHz16BitStereo',
    'SPLO_DYNAMIC', 'DISPID_SVIsUISupported', 'SpeechStreamFileMode',
    'SVEPrivate', 'DISPID_SpeechRecoResult', 'SPFM_OPEN_READONLY',
    'SPCATEGORYTYPE', '_RemotableHandle', 'SVEPhoneme',
    'DISPID_SLPLangId', 'SRAONone', 'SWTAdded', 'SPSHT_EMAIL',
    'DISPID_SRCEAudioLevel', 'SDA_One_Trailing_Space',
    'DISPID_SPIReplacements', 'SREAdaptation', 'SLODynamic',
    'ISpeechXMLRecoResult', 'DISPID_SLGenerationId',
    'DISPID_SRRTTickCount', 'DISPID_SpeechPhraseReplacement',
    'SP_VISEME_7', 'DISPID_SPCPhoneToId', 'SAFTGSM610_44kHzMono',
    'SpStream', 'SPDKL_LocalMachine', 'IInternetSecurityMgrSite',
    'DISPID_SMSSetData', 'DISPIDSPTSI_ActiveOffset', 'LONG_PTR',
    'DISPID_SGRSAddRuleTransition',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPRsItem',
    'DISPID_SpeechPhraseReplacements', 'ISpStream',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_RESERVED10', 'ISpRecoResult',
    'SPINTERFERENCE_NONE', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SASCurrentDevicePosition', 'SVP_8',
    'ISpeechTextSelectionInformation', 'DISPID_SGRSTs_NewEnum',
    'SPEI_SR_RETAINEDAUDIO', 'SP_VISEME_1', 'SPWT_LEXICAL',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechPhraseAlternate',
    'SVSFParseSsml', 'SpMMAudioIn', 'eLEXTYPE_PRIVATE2',
    'STSF_CommonAppData', 'SPWT_DISPLAY',
    'DISPID_SpeechPhraseElement', 'SPXMLRESULTOPTIONS',
    'DISPID_SRGId', 'DISPID_SABufferInfo', 'SAFTNonStandardFormat',
    'SGSEnabled', 'SPEI_START_SR_STREAM', 'DISPID_SRAudioInputStream',
    'SAFTADPCM_11kHzMono', 'SECFIgnoreCase', 'SAFTText',
    'DISPID_SGRSTsCount', 'SPGS_ENABLED', 'DISPID_SPAsItem',
    'DISPID_SVEVoiceChange', 'DISPID_SPRulesItem',
    'SPDKL_CurrentUser', 'DISPID_SpeechRecognizerStatus',
    'SAFTADPCM_8kHzMono', 'ISpeechWaveFormatEx', 'SASClosed',
    'DISPID_SRCEInterference', 'ISpDataKey', 'DISPID_SPAs_NewEnum',
    'DISPID_SRGRules', 'DISPID_SRGRecoContext',
    'SPINTERFERENCE_NOISE', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SOTCSetId', 'DISPID_SPPs_NewEnum',
    'DISPID_SpeechLexiconWord', 'DISPID_SASetState',
    'SVEStartInputStream', 'SPCS_ENABLED',
    'DISPID_SPEAudioStreamOffset', 'SPSModifier',
    'DISPID_SPIAudioSizeBytes', 'SPSHT_Unknown',
    'SpeechPropertyResourceUsage', 'DISPID_SADefaultFormat',
    'DISPID_SpeechBaseStream', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SAFGuid', 'SPWF_INPUT', 'SpeechCategoryAppLexicons',
    'SPSUnknown', 'ISpAudio', 'DISPID_SGRsFindRule',
    'eWORDTYPE_ADDED', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechGrammarRuleState', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRCCreateGrammar', 'SpeechRecoContextState',
    'SRESoundEnd', 'SPWORDPRONOUNCEABLE', 'DISPID_SpeechLexiconProns',
    'DISPID_SVAlertBoundary', 'DISPID_SVPause',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SDKCreateKey',
    'SECFIgnoreKanaType', 'SDTPronunciation', 'DISPID_SPRs_NewEnum',
    'SP_VISEME_16', 'DISPID_SDKGetlongValue', 'SWTDeleted',
    'SVSFIsXML', 'DISPID_SWFEAvgBytesPerSec', 'SPEI_UNDEFINED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE12',
    'DISPID_SLWsCount', 'SRSActive', 'DISPID_SLGetWords',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPERetainedSizeBytes',
    'ISpNotifySink', 'DISPID_SVGetProfiles', 'DISPID_SVEStreamEnd',
    'SAFT48kHz8BitStereo', 'SpPhoneConverter', 'SITooSlow',
    'SVSFlagsAsync', 'SAFT11kHz8BitStereo', 'SAFT24kHz8BitMono',
    'DISPID_SpeechObjectToken', 'DISPID_SpeechPhraseElements',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPIRule',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFT22kHz16BitMono', 'SREPrivate', 'DISPID_SFSOpen',
    'DISPID_SLPsCount', 'SPEI_RESERVED5', 'SP_VISEME_2',
    'DISPID_SRAudioInput', 'SPPS_RESERVED4', 'SVEWordBoundary',
    'DISPID_SRRPhraseInfo', 'SPCONTEXTSTATE',
    'SpPhoneticAlphabetConverter', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SDKSetBinaryValue', 'DISPID_SOTs_NewEnum',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SFSClose',
    'ISpeechGrammarRule', 'DISPID_SVPriority', 'SRAExport',
    'DISPID_SRCESoundEnd', 'SPSTREAMFORMATTYPE',
    'SAFTGSM610_11kHzMono', 'SPPS_Noun', 'SREBookmark',
    'SpMemoryStream', 'DISPID_SRCRetainedAudio',
    'SpInProcRecoContext', 'SVF_None', 'ISpLexicon',
    'ISpObjectTokenCategory', 'SGDisplay', 'ISpeechAudio',
    'DISPID_SOTCDefault', 'SGRSTTWildcard', 'DISPID_SPEs_NewEnum',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SOTCreateInstance',
    'DISPID_SRCRequestedUIType', 'DISPID_SVAudioOutputStream',
    'SGRSTTRule', 'DISPID_SVVoice', 'SpAudioFormat',
    'SPEI_PHRASE_START', 'SAFT44kHz8BitMono', 'DISPID_SVSVisemeId',
    'SPEI_INTERFERENCE', 'DISPID_SPEActualConfidence',
    'DISPID_SRGDictationLoad', 'DISPID_SGRsDynamic',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVP_7', 'SPSHT_OTHER',
    'DISPID_SASState', 'SPXRO_Alternates_SML', 'SREFalseRecognition',
    'SPAR_Unknown', 'DISPID_SPRuleNumberOfElements',
    'ISpeechPhraseProperties', 'ISpeechObjectTokenCategory',
    'SPLOADOPTIONS', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SGRSTRule', 'SPEI_END_INPUT_STREAM',
    'ISpeechGrammarRuleStateTransition', 'ISpeechVoice',
    'SAFT16kHz16BitStereo', 'DISPID_SMSGetData',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRCEFalseRecognition',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRRTOffsetFromStart', 'SPFILEMODE', 'SPEI_MAX_TTS',
    'SpeechPartOfSpeech', 'SpeechGrammarTagDictation',
    'ISpeechRecoGrammar', 'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_17',
    'DISPID_SpeechObjectTokenCategory', 'SVF_Emphasis',
    'SDA_No_Trailing_Space', 'SPSNotOverriden', 'SPSHT_NotOverriden',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPGS_EXCLUSIVE',
    'DISPID_SRCEAdaptation', 'SECFEmulateResult',
    'ISpeechAudioFormat', 'DISPID_SGRSRule', 'SPBO_AHEAD',
    'SpeechPropertyLowConfidenceThreshold', 'ISpRecoContext2',
    'DISPID_SpeechVoice', 'ISpResourceManager', 'SVP_18',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_ADAPTATION', 'SPSLMA', 'SGSDisabled', 'SAFT32kHz8BitStereo',
    'SpResourceManager', 'SPCT_SUB_DICTATION', 'SpeechRuleState',
    'DISPID_SWFEFormatTag', 'ISpVoice', 'SRAORetainAudio',
    'SpUnCompressedLexicon', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechAudioFormatGUIDWave', 'SPEI_SOUND_START',
    'SPEI_START_INPUT_STREAM', 'DISPID_SVSpeakStream',
    'ISpeechPhraseReplacements', 'SRTReSent',
    'SpeechVoiceSkipTypeSentence', 'eWORDTYPE_DELETED',
    'DISPID_SRRTimes', 'DISPID_SVSCurrentStreamNumber',
    'SPPHRASEELEMENT', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechCategoryAudioIn', 'SPDKL_CurrentConfig', 'SAFTDefault',
    'SPDATAKEYLOCATION', 'SpeechStreamSeekPositionType',
    'eLEXTYPE_PRIVATE15', 'DISPID_SLGetPronunciations',
    'ISpeechPhraseReplacement', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechGrammarTagUnlimitedDictation', 'SPAUDIOOPTIONS',
    'SPEVENTSOURCEINFO', 'SPXRO_SML', 'STCRemoteServer',
    'STCInprocServer', 'DISPID_SMSAMMHandle', 'SPRULESTATE',
    'DISPID_SGRId', 'SDTAll', 'ISpeechMemoryStream',
    'SpeechDictationTopicSpelling', 'ISpSerializeState',
    'SGRSTTEpsilon', 'SpeechAllElements', 'DISPID_SGRSTPropertyValue',
    'ISequentialStream', 'DISPID_SOTDataKey', 'SPWORDTYPE',
    'SREPropertyNumChange', 'STSF_AppData', 'SPSVerb',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTsItem', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPEEngineConfidence', 'SPGS_DISABLED', 'SpWaveFormatEx',
    'DISPID_SRCEBookmark', 'SpeechCategoryAudioOut', 'IStream',
    'SPGRAMMARWORDTYPE', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechGrammarRuleStateTransitionType', 'SRSEIsSpeaking',
    'SREAllEvents', 'DISPID_SDKSetStringValue', 'DISPID_SGRAddState',
    'DISPID_SBSRead', 'SPPHRASEPROPERTY', 'SpMMAudioEnum',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVEViseme',
    '_ISpeechRecoContextEvents', 'DISPID_SOTCEnumerateTokens',
    'SPLEXICONTYPE', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVSInputWordLength', 'DISPID_SRCSetAdaptationData',
    'SVSFParseAutodetect', 'ISpeechResourceLoader',
    'DISPID_SpeechGrammarRules', 'SVESentenceBoundary',
    'DISPID_SPPsCount', 'SVP_13', 'Speech_Max_Word_Length',
    'DISPID_SpeechGrammarRule', 'DISPID_SPEsItem', 'DISPID_SGRsCount',
    'DISPID_SLPPartOfSpeech', 'ISpPhrase', 'SpeechUserTraining',
    'SVSFNLPMask', 'DISPID_SpeechAudioBufferInfo',
    'Speech_Max_Pron_Length', 'DISPID_SpeechPhraseRule',
    'SPVPRI_OVER', 'SpeechEngineConfidence', 'DISPID_SOTsCount',
    'SVPOver', 'DISPID_SPAPhraseInfo', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SVSLastResult', 'DISPID_SLWWord', 'DISPID_SRCRecognizer',
    'ISpPhoneConverter', 'SDA_Two_Trailing_Spaces',
    'DISPID_SWFEBlockAlign', 'DISPID_SRRRecoContext', 'SPAO_NONE',
    'tagSPTEXTSELECTIONINFO', 'SpVoice', 'DISPIDSPRG',
    'SpSharedRecognizer', 'SPSHORTCUTPAIR', 'STCLocalServer',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechPhraseAlternates',
    'SREPropertyStringChange', 'DISPID_SPEDisplayText',
    'SAFT22kHz16BitStereo', 'Speech_StreamPos_RealTime',
    'DISPID_SRCState', 'DISPID_SRCEEnginePrivate', 'SPPHRASERULE',
    'DISPID_SVStatus', 'DISPID_SAStatus', 'DISPID_SLPSymbolic',
    'SRESoundStart', 'eLEXTYPE_PRIVATE17', 'DISPID_SRGReset',
    'DISPID_SOTSetId', 'SDTAudio', 'SRSActiveAlways',
    'DISPID_SPPNumberOfElements', 'SASStop',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPAS_CLOSED',
    'SGDSActiveWithAutoPause', 'SPINTERFERENCE_TOOLOUD', 'SASPause',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPCLangId',
    'DISPID_SpeechPhoneConverter', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechAudioState', 'DISPID_SpeechCustomStream', 'SRCS_Disabled',
    'SLTUser', 'SPVOICESTATUS', 'ISpRecognizer2',
    'SpeechGrammarState', 'eLEXTYPE_PRIVATE18', 'SVP_15',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVEBookmark', 'SVP_0',
    'SpeechAudioFormatGUIDText', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_VOICE_CHANGE', 'DISPID_SPPParent',
    'SPEI_RECO_OTHER_CONTEXT',
    'SpeechPropertyHighConfidenceThreshold',
    'ISpeechRecognizerStatus', 'SP_VISEME_11',
    'DISPID_SPEPronunciation', 'SP_VISEME_3',
    'DISPID_SRRGetXMLResult', 'SPEI_VISEME',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SOTMatchesAttributes',
    'SPSNoun', 'SAFT16kHz16BitMono', 'SPRULE',
    'DISPID_SRRDiscardResultInfo', '__MIDL_IWinTypes_0009',
    'DISPID_SWFEBitsPerSample', 'DISPID_SLAddPronunciation',
    'DISPID_SPAStartElementInResult', 'DISPID_SRProfile', 'SVP_21',
    'SPEI_SOUND_END', 'SGLexical', 'SpObjectToken', 'SPEVENT',
    'SP_VISEME_12', 'SPPS_RESERVED1',
    'SpeechRegistryLocalMachineRoot', 'SpStreamFormatConverter',
    'DISPID_SPIAudioSizeTime', 'DISPID_SpeechLexiconPronunciation',
    'ISpProperties', 'SpInprocRecognizer', 'IInternetSecurityManager',
    'SPEI_RECO_STATE_CHANGE', 'SpeechTokenShellFolder',
    'SPWORDPRONUNCIATION', 'SFTInput', 'DISPID_SVGetVoices',
    'SDTReplacement', 'SVSFIsFilename', 'tagSPPROPERTYINFO',
    'SGRSTTTextBuffer', 'SpeechAudioProperties', 'SPLO_STATIC',
    'SDKLCurrentUser', 'SAFT48kHz16BitStereo',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT12kHz16BitMono',
    'SSTTDictation', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTransitions',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPEAudioSizeTime',
    ...
    'DISPID_SRRSpeakAudio', 'DISPID_SPRuleName', 'SDKLLocalMachine',
    'SDTProperty', 'SVSFVoiceMask', 'DISPID_SRRAlternates',
    'SDA_Consume_Leading_Spaces', 'SP_VISEME_5', 'SSFMCreate',
    'SAFT11kHz16BitMono', 'SAFTNoAssignedFormat',
    'DISPID_SPRFirstElement', 'DISPID_SGRsCommitAndSave',
    'SpeechAddRemoveWord', 'DISPID_SRCEPropertyNumberChange',
    'SVSFIsNotXML', 'SpNotifyTranslator', 'DISPID_SPPValue',
    'SPTEXTSELECTIONINFO', 'SpeechCategoryVoices',
    'SpeechBookmarkOptions', 'SpeechWordType',
    'DISPID_SRRSaveToMemory', 'SRSInactive', 'SPEI_MIN_TTS',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SGRsCommit',
    'SpSharedRecoContext', 'eLEXTYPE_PRIVATE3', 'SP_VISEME_13',
    'DISPID_SPAsCount', 'DISPID_SRGCommit', 'SRTAutopause',
    'SP_VISEME_0', 'DISPID_SRCERecognition', 'SSFMCreateForWrite',
    'SPRS_ACTIVE', 'IEnumSpObjectTokens', 'SPPS_RESERVED2',
    'ISpRecoGrammar', 'DISPID_SVVolume', 'SPSHORTCUTPAIRLIST',
    'SpLexicon', 'SPPS_NotOverriden', 'SRTSMLTimeout', 'SPRECOSTATE',
    'eLEXTYPE_RESERVED8', 'SpeechCategoryRecoProfiles',
    'SpeechRuleAttributes', 'SpeechGrammarWordType',
    'DISPID_SpeechDataKey', 'SpeechRunState', 'SPEI_RESERVED6',
    'SPRECORESULTTIMES', 'DISPID_SpeechPhraseRules', 'SREHypothesis',
    'SPEI_RECOGNITION', 'SpeechPropertyComplexResponseSpeed',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SAEventHandle', 'SpeechCategoryRecognizers', 'SVP_20',
    'Speech_Default_Weight', 'ISpeechRecoResultTimes',
    'ISpeechDataKey', 'DISPID_SRCResume', 'SPEI_FALSE_RECOGNITION',
    'eLEXTYPE_PRIVATE9', 'SWPUnknownWordPronounceable',
    'SPSERIALIZEDRESULT', 'SPCT_DICTATION', 'SINoise',
    'SREPhraseStart', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVEBookmark', 'SLOStatic', 'ISpeechLexiconWords',
    'SpObjectTokenCategory', 'SRTStandard', 'STSF_LocalAppData',
    'SAFT12kHz8BitStereo', 'SP_VISEME_10', 'SVP_1',
    'SAFTCCITT_uLaw_11kHzStereo', 'SVP_2', 'SSSPTRelativeToStart',
    'DISPID_SPIElements', 'IEnumString', 'SAFT32kHz8BitMono',
    'SPGRAMMARSTATE', 'SGDSInactive', 'SPRST_INACTIVE',
    'SSTTWildcard', 'SpNullPhoneConverter', 'SpeechRecognizerState',
    'DISPID_SGRName', 'SPPS_Interjection', 'SpeechDiscardType',
    'SpeechPropertyAdaptationOn', 'SP_VISEME_19', 'SPVISEMES',
    'DISPID_SPERequiredConfidence', 'SPRST_NUM_STATES',
    'SpeechPropertyNormalConfidenceThreshold', 'STCInprocHandler',
    'ISpStreamFormatConverter', 'DISPID_SVResume',
    'DISPID_SPPConfidence', 'SRERecoOtherContext', 'SASRun',
    'DISPID_SABufferNotifySize', 'DISPID_SVSpeakCompleteEvent',
    'SAFT8kHz8BitMono', 'DISPID_SVGetAudioInputs',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SOTDisplayUI',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SDKDeleteKey', 'SRTExtendableParse',
    'DISPIDSPTSI_SelectionOffset', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SOTIsUISupported', 'DISPID_SRGDictationSetState',
    'SpeechRegistryUserRoot', 'SPBO_NONE', 'SPSFunction',
    'SPPS_Modifier', 'DISPID_SGRSTType', 'WAVEFORMATEX',
    'SPSEMANTICFORMAT', 'SPPS_SuppressWord', 'DISPID_SGRs_NewEnum',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRGetFormat', 'SREStreamEnd',
    'DISPID_SOTGetDescription', '_ISpeechVoiceEvents', 'SGSExclusive',
    'SPCS_DISABLED', 'DISPID_SVGetAudioOutputs', 'SAFT16kHz8BitMono',
    'SPEI_PHONEME', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRCEPhraseStart', 'SAFT24kHz8BitStereo',
    'DISPID_SMSALineId', 'DISPID_SPPName', 'DISPID_SGRClear',
    'SVP_10', 'SPCT_COMMAND', 'ISpeechLexicon', 'SAFTADPCM_44kHzMono',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVEWord',
    'DISPID_SRGetPropertyNumber', 'ISpEventSink', 'ISpRecoGrammar2',
    'DISPID_SBSWrite', 'SPPS_LMA', 'DISPID_SRCPause',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSAddSpecialTransition',
    'SRERecognition', 'SRSEDone', 'DISPID_SGRSTWeight',
    'DISPID_SpeechMMSysAudio', 'SVPAlert', 'SPEI_TTS_BOOKMARK',
    'SPPHRASEREPLACEMENT', 'ISpNotifyTranslator', 'SGDSActive',
    'SPRECOCONTEXTSTATUS', 'SpeechRetainedAudioOptions',
    'SpeechMicTraining', 'SVSFDefault', 'SpeechRecoEvents',
    'ISpeechAudioBufferInfo', 'ISpObjectWithToken',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SpeechObjectTokens',
    'SAFT11kHz8BitMono', 'DISPID_SABIBufferSize',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRCreateRecoContext',
    'DISPID_SPRules_NewEnum', 'DISPID_SLWsItem', 'DISPID_SDKOpenKey',
    'SPVPRI_NORMAL', 'eLEXTYPE_USER', 'SITooQuiet', 'SPPS_Verb',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechRecoResult',
    'ISpeechMMSysAudio', 'DISPID_SPIEnginePrivateData', 'SVP_3',
    'SPSSuppressWord', 'ISpNotifySource', 'SAFTADPCM_22kHzStereo',
    'SpMMAudioOut', 'DISPID_SPPFirstElement', 'SPPS_Noncontent',
    'DISPID_SPRuleConfidence', 'SRSInactiveWithPurge', 'SDTRule',
    'eLEXTYPE_VENDORLEXICON', 'SpeechEngineProperties',
    'SECFIgnoreWidth', 'SITooFast', 'DISPID_SOTCGetDataKey',
    'DISPID_SBSFormat', 'SPWAVEFORMATTYPE', 'SVPNormal',
    'eLEXTYPE_RESERVED7', 'SAFT11kHz16BitStereo', 'SP_VISEME_18',
    'SpeechAudioFormatType', 'DISPID_SRCEventInterests',
    'SPSEMANTICERRORINFO', 'SFTSREngine', 'SECFDefault',
    'DISPID_SRCERequestUI', 'DISPID_SLPsItem', 'eLEXTYPE_PRIVATE1',
    'DISPID_SAFSetWaveFormatEx', 'SAFT12kHz8BitMono',
    'DISPID_SRState', 'DISPID_SVSRunningState', 'ISpeechRecognizer',
    'ISpeechObjectToken', 'SDKLCurrentConfig', 'DISPID_SPIGetText',
    'eLEXTYPE_PRIVATE10', 'SpeechVoiceEvents', 'SP_VISEME_9',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechVoiceSpeakFlags',
    'DISPID_SVDisplayUI', 'SPEI_END_SR_STREAM', 'ISpObjectToken',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPELexicalForm',
    'DISPID_SGRSTNextState', 'ISpeechPhraseInfo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPRST_INACTIVE_WITH_PURGE', 'SpFileStream',
    'DISPID_SOTGetAttribute', 'DISPID_SPRsCount',
    'DISPID_SGRInitialState', 'SPRECOGNIZERSTATUS',
    'DISPID_SRIsShared', 'SAFT32kHz16BitMono', 'SSFMOpenReadWrite',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPISaveToMemory',
    'SPEI_SR_BOOKMARK', 'SVEViseme', 'SPVPRIORITY',
    'DISPID_SRGCmdSetRuleIdState', 'SREInterference',
    'DISPID_SLPType', 'SPPARTOFSPEECH', 'SGLexicalNoSpecialChars',
    'SpeechVisemeType', 'DISPID_SRGIsPronounceable', 'SPEI_RESERVED2',
    'DISPID_SRSetPropertyNumber', 'SRAImport',
    'SpeechRecognitionType', 'DISPID_SRCCmdMaxAlternates',
    'ISpPhraseAlt', 'SPAS_STOP', 'SRADynamic',
    'DISPID_SVWaitUntilDone', 'DISPID_SGRsAdd',
    'SpeechRecoProfileProperties', 'SGPronounciation',
    'DISPID_SPIEngineId', 'ISpStreamFormat',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecognizer',
    'DISPID_SVEAudioLevel', 'DISPID_SRGetPropertyString',
    'DISPID_SVAudioOutput', 'ISpeechCustomStream', 'SPINTERFERENCE',
    'SPAS_RUN', 'DISPID_SVSLastBookmark', 'DISPID_SAFType',
    'SREAudioLevel', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVEPhoneme', 'ISpEventSource', 'SAFT22kHz8BitStereo',
    'DISPID_SRCEEndStream', 'SRARoot', 'DISPID_SVEStreamStart',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechPhoneConverter'
]

_check_version('1.2.0', 1700467511.656734)
